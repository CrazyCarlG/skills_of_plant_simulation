...
|---|---|---|---|---|---|
| 2026-08-31 | **all 10 SKILL.md (verbosity audit)** | 4 | 3 | 1 | **see `skill-md-verbosity-audit-2026-08-31.md`** — 4 SKILL.md bloated (13–20 KB): class-management, write-simtalk, read-library, get-class-inheritance. Root cause: 3 cross-cutting duplication patterns (inherited quirks table × 7 skills, infoBox convention block × 4 skills, inheritance semantics table × 2 skills). Cut lists in `skill-md-verbosity-audit-2026-08-31-patches/`. Structural fix: ship 3 shared reference docs (`quirks-canonical.md` / `infoBox-convention.md` / `inheritance-semantics.md`) under `local-simtalk-execution/references/` → ~280 lines duplication removed repo-wide. |
...
7. **SKILL.md verbosity audit (2026-08-31).** 4 SKILL.md files (class-management, write-simtalk, read-library, get-class-inheritance) are 13–20 KB / 270–355 lines — significantly larger than the canonical `local-simtalk-execution` (86 lines) and `local-simtalk-os-functions` (77 lines). Root cause: **3 cross-cutting duplication patterns** — see `skill-md-verbosity-audit-2026-08-31.md` and `cross-cutting-shared-refs.md` for the structural fix (~280 lines removable repo-wide via 3 new shared reference docs). Per-skill cut lists in `skill-md-verbosity-audit-2026-08-31-patches/`.

---

*Generated by skills-optimizer. First pass: 2026-08-27. Delta r2: 2026-08-27. Verbosity audit: 2026-08-31.*
