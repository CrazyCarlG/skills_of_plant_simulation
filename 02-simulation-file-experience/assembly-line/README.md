...
- `02-simulation-file-experience/simtalkclaude-best-practices.md` —
  SimtalkClaude v1 baseline (still applies; same TCP bridge)
- `02-simulation-file-experience/facory51/` — Siemens Factory51 +
  SimtalkClaude v2 experience (orthogonal model, complementary
  patterns)
- `02-simulation-file-experience/ctu-warehouse/` — class-inheritance
  reverse-verification pattern (a different approach to library
  navigation)
- `02-simulation-file-experience/skill-call-playbook.md` — 9-skill
  usage playbook
