...
scope: assembly-line 模型架构 / UserObjects 库拆分 / WorkerChart Frame-with-UI / PalletOptimization 等业务模式
---
...
- `../factory51/README.md` — Factory51 + SimtalkClaude v2 (orthogonal model)
- `../../02-bridge-tool/simtalkclaude-v1-and-v2.md` — SimtalkClaude v1+v2 base experience
