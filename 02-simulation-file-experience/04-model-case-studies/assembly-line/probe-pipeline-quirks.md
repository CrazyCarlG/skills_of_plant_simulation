...
scope: local-simtalk-read-library 在 assembly-line 上撞到的工具层 bug（2 个 pipeline-level issue）+ workaround
---
...
- `../../02-bridge-tool/simtalkclaude-v1-and-v2.md` §5.2 — same issue observed on
  SimtalkClaude v1 dump (single-method + sleep pattern)
- `factory51/` — same readlog ceiling observed during Factory51
  probing
