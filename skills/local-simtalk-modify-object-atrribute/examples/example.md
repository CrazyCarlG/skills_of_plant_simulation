# Example: Using `local-simtalk-modify-object-atrribute`
...
python3 /root/skills_of_plant_simulation/skills/local-simtalk-execution/scripts/simtalk_send.py ping
...
```bash
python3 /root/skills_of_plant_simulation/skills/local-simtalk-execution/scripts/simtalk_send.py \
    --timeout 15 run '
...
python3 /root/skills_of_plant_simulation/skills/local-simtalk-execution/scripts/simtalk_send.py readlog
```
